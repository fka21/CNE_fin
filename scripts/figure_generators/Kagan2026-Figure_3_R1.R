...
LABEL_CONTRAST <- list(
  "Developmental"        = 1.3,
  "Signaling"            = 1,
  "Cellular_metabolic" = 1
)
INCLUDE_SIGNALING <- TRUE   # FALSE drops the Signaling sub-panel
INCLUDE_METABOLISM <- FALSE   # FALSE drops the Metabolism sub-panel
...
"Signaling pathways" = c(
  ...
  "GO:0048384",  # retinoic acid receptor signaling pathway  (new; test for connectivity)
  "GO:0048385"   # regulation of retinoic acid receptor signaling pathway  (new; test for connectivity)
),
  "Cellular_metabolic" = c(
...
if (!INCLUDE_METABOLISM) category_anchors$Cellular_metabolic <- NULL
...
ggsave("go_two_panel_figure_R1_v2.pdf", fig,
       width = 12, height = 16, bg = "white")

cat("Wrote go_two_panel_figure_R1_v2.pdf\n")