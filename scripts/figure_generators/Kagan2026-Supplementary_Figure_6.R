...
summary_acti  <- build_summary("actinopterygii_cne_final_table.tsv",
                               "actinopterygii", "Actinopterygii-specific")
summary_gnath <- build_summary("gnathostomata_cne_final_table.tsv",
...
ggsave(sprintf("top%d_flank_hotspots_summary.pdf", TOP_N), p,
       width = 7, height = 8,  bg = "white")
cat(sprintf("\nWrote top%d_flank_hotspots_summary.pdf\n", TOP_N))
