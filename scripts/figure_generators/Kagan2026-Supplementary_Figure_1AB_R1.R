...
## ---- 1. Configuration ------------------------------------------------------
#bed_file   <- "gnathostomata_conserved_drer_R1_20260731.bed"      # CNE coordinates
#tsv_file   <- "gnathostomata_cne_final_table_R1_20260731.tsv"    # annotation / gene models
# out_prefix <- "gnathostomata_cne_panels_zfhx4"        # output file prefix

bed_file   <- "actinopterygii_specific_drer_R1_20260731.bed"      # CNE coordinates
tsv_file   <- "actinopterygii_cne_final_table_R1_20260731.tsv"    # annotation / gene models
out_prefix <- "actinopterygii_cne_panels_pcdh"        # output file prefix
...
regions <- data.frame(
  ...
  accession = c("NC_133185",      "NC_133189"),
  win_start = c(26.4e6,          2.32e6),
  win_end   = c(26.7e6,          2.9e6),
